...
![测试图片](/image/01.png)
![稀土](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c93fdc31010847d0a16c3e0a7d7cf3cd~tplv-k3u1fbpfcp-zoom-crop-mark:3024:3024:3024:1702.awebp?)
...
```js
//箭头函数没有arguments 使用...rest(剩余参数)来代替
//箭头函数不能new
//箭头函数自身没有this，this是声明时作用域的this
//箭头不能用过call，apply，bind绑定this
...
let obj = {
	a: 1,
	say: () => {
		console.log(this, this.a); //window 100
	},
	fun: function(){
...
Array.prototype.myMap = function (thisFun) {
  if (typeof thisFun !== 'function') throw TypeError('123')
